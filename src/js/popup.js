...
$('#collapsible-commit-message-icon').click(function () {
...
$('#collapsible-difficulty-icon').click(function () {
  $(this).find('.collapsible-icon').toggleClass('open');
...
$('#collapsible-language-icon').click(function () {
  $(this).find('.collapsible-icon').toggleClass('open');
...
$('#collapsible-timestamp-icon').click(function () {
  $(this).find('.collapsible-icon').toggleClass('open');
...
$('#collapsible-solution-post-icon').click(function () {
  $(this).find('.collapsible-icon').toggleClass('open');
          ...
          chrome.storage.local.get('mode_type', data2 => {
            if (data2 && data2.mode_type === 'commit') {
              ...
              chrome.storage.local.get(['stats', 'leethub_hook'], data3 => {
                ...
                const loadLocalStats = platform => {
                  const stats = data3.stats?.platformStats?.[platform];
                  if (stats) {
